...
Funcionário 5: R$ 50.000 (CEO)

```

Média: (2.000 + 2.500 + 3.000 + 3.500 + 50.000) ÷ 5 = R$ 12.200

Isso engana! Nenhum funcionário ganha perto de R$ 12.200.
...
Caso 1: Número Ímpar de Dados (fácil)
...
Caso 2: Número Par de Dados (um pouco mais complicado)
...
|Você quer "valor típico"|	—|	✅|	Mediana|
|Você quer "resultado geral"|	✅|	—|	Média|
